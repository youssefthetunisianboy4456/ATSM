	...
	annonceText=`
		...
		<div class="annonces-heading">
			<div>
				...
				<a href="../Annonces/typeAnnonce.html?title=passées&types=passed&types=competiton&types=release" class="all-annonces">
		...
		<div class="annonces-heading">
			<div>
				...
				<a href="../Annonces/typeAnnonce.html?title=à%20venir&types=upcoming&types=stage&types=test" class="all-annonces">
					Voir toutes les actualités →
				</a>
				<div class="title-line"></div>
			</div>
